    ...
    return (
        <main className="grid grid-cols-1 my-auto">
            <ul className="flex flex-wrap gap-[60px] justify-center ">
                ...
                <li><CardProject name="Project 3" nameCommit="DigitalAgencyCompany" description="Three project on next" img={`${process.env.NODE_ENV === 'production' ? '/portfolio' : ''}/images/SiteFilm3.png`} link="https://lipowerad.github.io/Digital-Agency-Company/" /></li>
            </ul>
        </main>
    )
}
